...
// --- Placeholder Assets ---
const BOTTLE_IMG_1 = Bottle1;
const BOTTLE_IMG_2 = Bottle2;
const BOTTLE_IMG_3 = Bottle3;
...
const BOTTLE_OPTIONS = [
  ...
  { id: 'b4', name: 'Love Potion', src: BOTTLE_IMG_1 },
  { id: 'b5', name: 'Neon Soda',   src: BOTTLE_IMG_2 },
  { id: 'b6', name: 'Crystal Ice', src: BOTTLE_IMG_3 },
  { id: 'b7', name: 'Aged Oak',    src: BOTTLE_IMG_1 },
  { id: 'b8', name: 'Cactus Jack', src: BOTTLE_IMG_2 },
];
...
export const SpinTheBottle: React.FC = () => {
  ...
  const handleSpin = useCallback(() => {
    ...
    setTimeout(() => {
      ...
      const segment = BOARD_SEGMENTS[segmentIndex];
      setSpinResult(segment.label);

      // Calculate points
      let points: number;
      if (segment.label === "MYSTERY") {
        points = Math.floor(Math.random() * 401) + 100; // 100-500
      } else {
  ...
  if (!state.sessionActive) {
    return (
      <div className="relative w-full h-screen bg-[#411366] flex flex-col items-center justify-center">
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#411366] flex flex-col font-sans overflow-x-hidden">
      {/* Timer */}
      ...
      {/* Main Game Area */}
      <div className="flex-1 overflow-y-auto flex flex-col items-center justify-center relative w-full pb-20">
        {/* Status Header */}
      ...
      >
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            ...
            {isDockOpen ? <ChevronDown size={14} className="text-[#FF00B2]" /> : <ChevronUp size={14} className="text-[#FF00B2]" />}
          </button>
