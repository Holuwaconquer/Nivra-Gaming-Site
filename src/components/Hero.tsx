...
const Hero = () => {
  return (
    <div className="relative w-full min-h-screen py-[50px] md:py-[4%] px-[28px] md:px-[48px] overflow-hidden flex items-center">
      {/* Lottie Background Animation - Cover entire hero section */}
      ...
      <div 
        ...
        style={{
          background: "linear-gradient(to bottom, rgba(33, 7, 54, 0.72), rgba(33, 7, 54, 0.72))"
        }}
      />
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto">
        <div className="w-full grid items-center justify-center md:grid-cols-2 md:justify-between gap-8">
          ...
          <div className="w-full flex flex-col gap-3 md:gap-6">
            <h1 className="text-[2em] md:text-[5em] text-center md:text-left font-bold leading-[1em] relative">
            ...
            <p className="text-[20px] text-center md:text-left md:text-[2em] font-semibold text-white">
              The Ideal content for <span className="text-[#DA07E0]">Gamers</span>
            </p>
            
            <p className="text-[14px] md:text-[16px] text-center md:text-left font-semibold text-gray-300 leading-relaxed max-w-2xl">
            ...
            <div className="w-full flex gap-4 items-center justify-center md:justify-start">
              <button className="cursor-pointer text-white py-[12px] px-[15px] md:px-[32px] bg-[#411366] hover:bg-[#512376] transition-all duration-300 font-semibold text-lg shadow-lg hover:shadow-purple-500/25 hover:scale-105">
                Join Now
              </button>
              <button className="cursor-pointer text-white py-[12px] px-[15px] md:px-[32px] bg-[#D932FE] hover:bg-[#E845FF] transition-all duration-300 font-semibold text-lg shadow-lg hover:shadow-pink-500/25 hover:scale-105">
                Learn About Us
              </button>
            </div>
            
            <div className='hidden md:flex justify-center md:justify-start items-center gap-6 text-[#D932FE] text-[28px] md:text-[30px] pt-4'>
